> **ARCHIVED 2026-08-18.** This is the original claude.ai planning handoff
> plus the first sessions' running log, kept for history. Sections 3 and 8
> (product shape, build order) and parts of the log were superseded by the
> scoping conversations of 2026-08-18. The current truth lives in
> `docs/VISION.md` (product definition) and `docs/plan.md` (phases).
> Sections 1-2 (mission, hard rules) remain binding and are restated in
