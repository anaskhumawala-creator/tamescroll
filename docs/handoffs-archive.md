...
Superseded session handoffs, 2026-08-18 to 2026-09-03 16:30, moved out
of CLAUDE.md on 2026-09-04. They are history, not instructions: the
rules that still bind were distilled into CLAUDE.md's STANDING RULES
section and anything here may have been overtaken. Read it for the WHY
behind a decision, never as a current fact.
