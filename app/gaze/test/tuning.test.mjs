...
const SHIPPED = {
  ...
  GENDER_IMAGE_NM_FLOOR: genderVerdict.GENDER_IMAGE_NM_FLOOR,
  GENDER_IMAGE_MIN_SCORE: genderVerdict.GENDER_IMAGE_MIN_SCORE,
  STATIC_VERDICT_MS: cadence.STATIC_VERDICT_MS,
  STATIC_DELTA: sceneGate.STATIC_DELTA,
  ...
  DELAY_LATE_ATTACH: delayCore.DELAY_LATE_ATTACH,
