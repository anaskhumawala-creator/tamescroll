...
let CUTS = (() => {
  try { return JSON.parse(fs.readFileSync(`${ROOT}/bank/cuts-60.json`, 'utf8')); }
  catch (e) { return {}; }
})();
...
export function assertCutsFresh(shipped) {
  ...
  if (!meta) throw new Error(
    'bank/cuts-60.json has no __meta stamp -- it predates the check and its '
  ...
  if (shipped && meta.CUT_DELTA !== shipped.CUT_DELTA) throw new Error(
    `bank/cuts-60.json was banked at CUT_DELTA ${meta.CUT_DELTA}, the bundle `
