...
//
// MEM_SIM is the other way to the same place: if one person's reads
...
console.log('\nMEM_SIM              EXPOSURE  FALSECOVER   PHANTOM');
for (const [name, path] of [['0.50', './.cache/sim0.50.mjs'], ['0.55', './.cache/sim0.55.mjs'],
  ['0.60 (shipped)', './.cache/shipped.mjs'], ['0.65', './.cache/sim0.65.mjs'],
  ['0.70', './.cache/sim0.70.mjs']]) {
