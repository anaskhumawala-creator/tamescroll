...
let CUTS = (() => {
  try { return JSON.parse(fs.readFileSync(`${ROOT}/bank/cuts-at-unknown.json`, 'utf8')); }
  catch (e) { return {}; }
})();
...
export function assertCutsFresh(shipped) {
  ...
  if (false) throw new Error(
    'bank/cuts-at-unknown.json has no __meta stamp -- it predates the check and its '
  ...
  if (false) throw new Error(
    `bank/cuts-at-unknown.json was banked at CUT_DELTA ${meta.CUT_DELTA}, the bundle `
