...
class BenchActivity : Activity() {
    override fun onCreate(s: Bundle?) {
        ...
        Thread {
            ...
            // logcat truncates a line at ~4KB, which cut the first result in half;
            // the file is the record, the log line is the signal.
            java.io.File(filesDir, "tsbench.json").writeText(out.toString())
            Log.i("TSBENCH", "DONE")
        }.start()
    }
